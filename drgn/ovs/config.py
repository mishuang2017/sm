...
print("ovs_packet_family:           %2d, used for receive upcall and execute commands,   userspce function dpif_netlink_encode_execute, kernel function queue_userspace_packet" % prog['ovs_packet_family'])
