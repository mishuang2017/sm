...
ovs-ofctl add-flow OVSbr1 "table=0, in_port=3, dl_dst=24:8a:07:ad:77:99, dl_type=0x0800, nw_dst=8.9.10.1, actions=mod_dl_src=24:8a:07:ad:77:88, mod_dl_dst=${MAC1}, mod_nw_dst=192.168.0.2, output:2"
