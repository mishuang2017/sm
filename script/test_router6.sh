...
[[ $(hostname -s) == "dev-r630-03" ]] && MAC2=02:25:d0:14:01:02
[[ $(hostname -s) == "dev-r630-04" ]] && MAC2=02:25:d0:13:01:02
...
ovs-ofctl add-flow $br "table=1,in_port=2,ct_state=+trk+est,ip,action=mod_dl_src:${MAC_ROUTE},mod_dl_dst:${MAC2},5"
ovs-ofctl add-flow $br "table=1,in_port=5,ct_state=+trk+est,ip,action=mod_dl_src:${MAC_ROUTE},mod_dl_dst:${MAC1},2"
