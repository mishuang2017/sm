...
MAC2=24:8a:07:88:27:ca	# ping from 13

MAC1=02:25:d0:14:01:02
MAC2=24:8a:07:88:27:9a	# ping from 14
...
ovs-ofctl add-flow $br "table=0, in_port=5, dl_dst=${MAC_ROUTE}, dl_type=0x0800, nw_dst=8.9.10.1, actions=mod_dl_src=${MAC_ROUTE}, mod_dl_dst=${MAC1}, mod_nw_dst=192.168.0.2, output:2"
